...
<body>
	<main class="fluid-container">
		...
		<div class="container">
			...
			<form action="actions/applicationForm.php" method="post" id="formApp" class="needs-validation" novalidate enctype="multipart/form-data">
				<!-- Start Admission NO. -->
				<div class="row">
					<div class="col">
						<div class="card">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-6 mb-3 mb-md-3 m-lg-0">
										...
										<input oninput="validateCollegeCode()" type="text" value="" maxlength="3" inputmode="tel" id="collageId" class="form-control" name="collegeCode" required />
										<div class="invalid-feedback"></div>
									</div>
									<div class="col-md-6 mb-0">
										<small class="form-text text-muted mb-1">Roll Number</small>
										<input oninput="validateRollNumber()" id="rollNumber" type="text" class="form-control text-uppercase" maxlength="7" name="rollNumber" required />
										<div class="invalid-feedback"></div>
									</div>
								</div>
							</div>
							...
							<div class="card-body">
								<div class="row">
									<div class="form-group col-12 col-md-4 mb-3 mb-md-3 m-lg-0">
										...
										<input oninput="validateStudentName()" type="text" class="form-control text-uppercase" id="studentName" maxlength="25" name="studentName" required />
										<div class="invalid-feedback"></div>
									</div>
									<div class="form-group col-12 col-md-4 mb-3 mb-md-3 m-lg-0">
										<small class="form-text text-muted mb-1">Father's Name</small>
										<input oninput="validateFathertName()" type="text" class="form-control text-uppercase" id="fatherName" name="fatherName" required />
										<div class="invalid-feedback"></div>
									</div>
									...
									<div class="form-group col mb-0">
										<div class="d-flex">
											<div class="form-check">
												<input onchange="validateGender()" class="form-check-input" type="radio" name="gender" id="maleRadios" value="Male" />
												<label class="form-check-label" for="maleRadios">Male</label>
												<input onchange="validateGender()" class="form-check-input ml-4" type="radio" name="gender" id="femaleRadios" value="Female" />
						...
						<div class="card">
							...
							<div class="card-body">
								<ul id="social_state" class="grid-container">
									<li class="form-check">
										<input onchange="radioState()" class="form-check-input" type="radio" name="socialState" id="gridRadios3" value="SC" />
										<label class="form-check-label" for="gridRadios3"> SC </label>
									</li>
									<li class="form-check">
										<input onchange="radioState()" class="form-check-input" type="radio" name="socialState" id="gridRadios4" value="BC-C" />
										<label class="form-check-label" for="gridRadios4"> BC-C </label>
									</li>
									<li class="form-check">
										<input onchange="radioState()" class="form-check-input" type="radio" name="socialState" id="gridRadios5" value="ST" />
										<label class="form-check-label" for="gridRadios5"> ST </label>
									</li>
									<li class="form-check">
										<input onchange="radioState()" class="form-check-input" type="radio" name="socialState" id="gridRadios6" value="EC-D" />
										<label class="form-check-label" for="gridRadios6"> EC-D </label>
									</li>
									<li class="form-check">
										<input onchange="radioState()" class="form-check-input" type="radio" name="socialState" id="gridRadios7" value="BC-A" />
										<label class="form-check-label" for="gridRadios7"> BC-A </label>
									</li>
									<li class="form-check">
										<input onchange="radioState()" class="form-check-input" type="radio" name="socialState" id="gridRadios8" value="BC-E" />
										<label class="form-check-label" for="gridRadios8"> BC-E </label>
									</li>
									<li class="form-check">
										<input onchange="radioState()" class="form-check-input" type="radio" name="socialState" id="gridRadios9" value="BC-B" />
										<label class="form-check-label" for="gridRadios9"> BC-B </label>
									</li>
									<li class="form-check">
										<input onchange="radioState()" class="form-check-input" type="radio" name="socialState" id="gridRadios10" value="Others" />
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-md-6 mb-0">
										...
										<input oninput="validateMobile()" id="mobileNo" name="mobileNo" class="form-control" type="text" maxlength="10" inputmode="tel" required />
										<div class="invalid-feedback"></div>
									</div>
								</div>
							</div>
							...
							<div class="card-body">
								<div class="appearing-container">
									<div class="year">
										...
										<div class="yearRatio">
											<div class="form-check">
												<input class="form-check-input" type="radio" name="yearofAppearing" id="yearRadio1" value="Fisrt Year" />
												<label class="form-check-label" for="yearRadio1">I</label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="yearofAppearing" id="yearRadio2" value="Second Year" />
												<label class="form-check-label" for="yearRadio2">II</label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="yearofAppearing" id="yearRadio3" value="Third Year" />
												<label class="form-check-label" for="yearRadio3">III</label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="yearofAppearing" id="yearRadio4" value="Forth Year" />
												<label class="form-check-label" for="yearRadio4">IV</label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="yearofAppearing" id="yearRadio5" value="Fifth Year" />
									...
									<div class="semester">
										...
										<div class="semRatio">
											<div class="form-check">
												<input class="form-check-input" type="radio" name="semofAppearing" id="semRadio1" value="First Semester" />
												<label class="form-check-label" for="semRadio1">I</label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="semofAppearing" id="semRadio2" value="Second Semester" />
									...
									<div class="appearing">
										...
										<div class="appRatio">
											<div class="form-check">
												<input class="form-check-input" type="radio" name="appearingAs" id="appRadio1" value="Regular" />
												<label class="form-check-label" for="appRadio1">Regular</label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="appearingAs" id="appRadio2" value="External" />
												<label class="form-check-label" for="appRadio2">External</label>
											</div>
											<div class="form-check">
												<input class="form-check-input" type="radio" name="appearingAs" id="appRadio3" value="Improvement" />
