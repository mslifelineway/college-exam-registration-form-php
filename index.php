						...
						<div class="card">
							...
							<div class="card-body">
								<ul id="social_state" class="grid-container">
									<li class="form-check">
										<input class="form-check-input" type="radio" name="socialState" id="gridRadios3" value="SC" />
										<label class="form-check-label" for="gridRadios3"> SC </label>
									</li>
									<li class="form-check">
										<input class="form-check-input" type="radio" name="socialState" id="gridRadios4" value="BC-C" />
										<label class="form-check-label" for="gridRadios4"> BC-C </label>
									</li>
									<li class="form-check">
										<input class="form-check-input" type="radio" name="socialState" id="gridRadios5" value="ST" />
										<label class="form-check-label" for="gridRadios5"> ST </label>
									</li>
									<li class="form-check">
										<input class="form-check-input" type="radio" name="socialState" id="gridRadios6" value="EC-D" />
										<label class="form-check-label" for="gridRadios6"> EC-D </label>
									</li>
									<li class="form-check">
										<input class="form-check-input" type="radio" name="socialState" id="gridRadios7" value="BC-A" />
										<label class="form-check-label" for="gridRadios7"> BC-A </label>
									</li>
									<li class="form-check">
										<input class="form-check-input" type="radio" name="socialState" id="gridRadios8" value="BC-E" />
										<label class="form-check-label" for="gridRadios8"> BC-E </label>
									</li>
									<li class="form-check">
										<input class="form-check-input" type="radio" name="socialState" id="gridRadios9" value="BC-B" />
										<label class="form-check-label" for="gridRadios9"> BC-B </label>
									</li>
									<li class="form-check">
										<input class="form-check-input" type="radio" name="socialState" id="gridRadios10" value="Others" />
